...
export default function Contact() {
    ...
    const handleSend = () => {
        window.location.href = `mailto:gredok@gmail.com?subject=Contact&body=${encodeURIComponent(message)}`;
    }
    return (
            ...
            <div className="row wrap-row" style={{gap: 35, marginTop: 50}}>
                ...
                <div className="diff-color-bg" style={{padding: 25, gap: 20}}>
                   ...
                   <div className="col" style={{gap: 15}}>
                        <Link href="mailto:gredok@gmail.com" style={{fontWeight: "normal"}}>
