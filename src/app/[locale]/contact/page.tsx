...
export default function Contact() {
    ...
    const handleSend = () => {
        window.location.href = `mailto:contact@bap-org.com?subject=Contact&body=${encodeURIComponent(message)}`;
    }
    return (
            ...
            <div className="row wrap-row" style={{gap: 35, marginTop: 50}}>
                ...
                <div className="diff-color-bg" style={{padding: 25, gap: 20}}>
                   ...
                   <div className="col" style={{gap: 15}}>
                        <Link href="mailto:contact@bap-org.com" style={{fontWeight: "normal"}}>
